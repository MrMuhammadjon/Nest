...
export default function Header() {
    ...
    const headdetalis = [
        ...
        { id: 6, name: "Mega menu", link: "/mega-menu" },
        ...
        <header className="w-full flex flex-col bg-white shadow-md">
            ...
            <div className="w-full border-t border-gray-200 bg-white">
                <div className="w-[90%] mx-auto flex items-center justify-between py-3">
                    <button className="bg-green-600 hover:bg-green-500 text-white px-4 py-2 rounded flex items-center gap-2 cursor-pointer">
